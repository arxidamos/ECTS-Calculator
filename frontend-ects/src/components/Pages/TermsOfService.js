...
const TermsOfService = () => {
  return (
    <div className="privacy-policy">
      <h2>Όροι Χρήσης</h2>
      <p>
        Το ECTS Tool είναι ένα εργαλείο υπολογισμού των απαιτήσεων ολοκλήρωσης του προγράμματος σπουδών του Τμήματος Πληροφορικής και Τηλεποικοινωνιών της Σχολής Θετικών Επιστημών του ΕΚΠΑ. Πριν χρησιμοποιήσετε αυτή την εφαρμογή, διαβάστε προσεκτικά τους ακόλουθους όρους και προϋποθέσεις. 
      </p>
